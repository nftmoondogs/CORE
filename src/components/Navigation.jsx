...
<div className={`${layout.sectionInfo} drop-shadow-2xl sm:pt-52 sm:pb-0 sm:pl-32`}>
  ...
  WOOF token is used to empower WOOFLABS decentralized ecosystem building at the forefront of web3 on CoreDao Blockchain and is also used in our OpenWaters NFT Marketplace to buy and sale NFTs <div className={` pt-4 w-full flex w-[100%] h-[100%]`}>
