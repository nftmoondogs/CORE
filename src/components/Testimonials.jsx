...
<div className={`${layout.sectionInfo} sm:flex drop-shadow-2xl sm:pt-52 sm:pb-0 sm:pr-32`}>
  <h2 className={`${styles.heading4}`}>OpenWaters is The best NFT Marketplace on CoreDAO Blockchain for everyone by 
WOOF LABS OpenWaters is powered by our $WOOF token.
</h2>
  <p className={`${styles.paragraph2} pt-6 sm:pb-96 pt-0.5`}>
  OpenWaters<div className={` pt-4 w-full  flex w-[100%] h-[100%]`}>
